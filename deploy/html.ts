...
const DEFAULT_DESCRIPTION = 'Write, share, and publish docs quickly on FreeFlowy.\nGet started for free.';
...
> = {
  '/after-payment': {
    title: 'Payment Success | FreeFlowy',
    description: 'Payment success on FreeFlowy',
  },
  '/login': {
    title: 'Login | FreeFlowy',
    description: 'Login to FreeFlowy',
  },
};
...
export const renderPublishPage = ({ hostname, pathname, metaData, publishError }: RenderPublishPageOptions) => {
  ...
  setOrUpdateMetaTag($, 'meta[property="og:site_name"]', 'property', 'FreeFlowy');
